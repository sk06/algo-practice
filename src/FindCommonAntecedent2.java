...
public class FindCommonAntecedent2 {
	    ...
	    public static String findClosestAntecedent(String name1, String name2) {
	        ...
	        if (familyTree.containsKey(name1) && familyTree.containsKey(name2)){
	            ...
	            if(familyTree.get(name1).equals(name2))
	            	...
	            	findClosestAntecedent(familyTree.get(name1), name2);
	            
	            if(familyTree.get(name2).equals(name1))
	                return name1;
	            else
	                findClosestAntecedent(name1, familyTree.get(name2));   
	        }
	        return "";
	    }
